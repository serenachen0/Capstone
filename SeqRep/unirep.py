"""
Adapted from Church Lab's UniRep
https://github.com/churchlab/UniRep/blob/master/unirep.py
"""
...
class babbler1900():
    ...
    def get_softmax(self,seq):
        """
        Input a valid amino acid sequence, 
        outputs the probability, i.e., softmax(logits), of each amino acid at each position
        """
        with tf.Session() as sess:
