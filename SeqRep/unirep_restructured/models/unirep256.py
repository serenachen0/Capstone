...
class UniRep256(BaseModel):
    """
    UniRep model with 256 units in 4 stacked mLSTM cells.
    This is the medium model, corresponding to the original babbler256.
    """
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        super(UniRep256, self).__init__(config=config, name="unirep256", **kwargs)
